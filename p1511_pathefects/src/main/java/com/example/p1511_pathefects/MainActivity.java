package com.example.p1511_pathefects;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(new DrawView6(this));
    }
    ...
    class DrawView6 extends View {
        ...
        public DrawView6(Context context) {
            super(context);
            path = new Path();
            path.addRect(-100, 0, 100, 500, Path.Direction.CW);
